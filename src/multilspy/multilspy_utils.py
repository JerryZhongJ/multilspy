...
class FileUtils:
    ...
    @staticmethod
    def read_file(file_path: str, logger: logging.Logger) -> str:
        """
    ...
    @staticmethod
    def download_file(url: str, target_path: str, logger: logging.Logger) -> None:
        """
    ...
    def download_and_extract_archive(
        url: str, target_path: str, archive_type: str, logger: logging.Logger
    ) -> None:
        """
        ...
        try:
            FileUtils.download_file(url, tmp_file_name, logger)
